...
class EstoqueService {
  ...
  static async entrada({
    ...
    const atualizado = await Estoque.aumentarTotal(
      id_produto,
      quantidade
    );
  ...
  static async baixar({
    ...
    try {
      const atualizado = await Estoque.diminuirTotal(
        id_produto,
        quantidade
      );
  ...
  static async reservar({
    ...
    const atualizado = await Estoque.aumentarReserva(
      id_produto,
      quantidade
    );
  ...
  static async liberarReserva({
    ...
    try {
      const atualizado = await Estoque.diminuirReserva(
        id_produto,
        quantidade
      );
